...
Pod::Spec.new do |s|
  s.name             = 'Saffron'
  s.version          = '0.1.0'
  s.summary          = 'A short description of Saffron.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/jere@coniferproductions.com/Saffron'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'jere@coniferproductions.com' => 'jere@coniferproductions.com' }
